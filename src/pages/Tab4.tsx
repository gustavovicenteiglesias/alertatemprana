...
import { IonCol, IonContent, IonGrid, IonHeader, IonItem, IonLabel, IonPage, IonRow, IonText, IonThumbnail, IonTitle, IonToolbar } from '@ionic/react';
      ...
      {/* <img src={require('../assest/image/logofull.png')} className="logoareco" 
        ...
        <p>El SMGR y la aplicación "SAT Areco" son acciones de Adaptación al Cambio Climático
           ...
           <IonGrid>
            <IonRow>
              <IonCol>
              <img src={require('../assest/image/banner.png')}   className="logobanner" />
              </IonCol>
            </IonRow>
           </IonGrid>
