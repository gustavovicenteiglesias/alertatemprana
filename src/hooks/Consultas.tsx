...
export const useGetCP = () => {
  ...
  const getData = async () => {
    const  alertas = await get<CortoPlazoUltimo>('https://areco.gob.ar:9534/v1/cortoplazo/ultimo');
...
export const useGetAM = () => {
  ...
  const getData = async () => {
    const  alertas = await get<AlertaMUltimo>('https://areco.gob.ar:9534/v1/alertameteorologico/ultimo');
...
export const useGetForescast = () => {
    ...
    const getData = async () => {
      const { forecast } = await get<APIResponse>('https://areco.gob.ar:9534/v1/getPronostico');
...
export const useGetDia=()=>{
  ...
  const apiDia ="https://areco.gob.ar:9534/v1/getDia"; 
    const getData = async () => {
...
export const useGetSituacion=()=>{
  ...
  const url ="https://areco.gob.ar:9534/v1/situacion/ultimo"; 
    const getData = async () => {
...
export const useGetRegistros=()=>{
  ...
  const url ="https://areco.gob.ar:9534//v1/registros/ultimo"; 
    const getData = async () => {
